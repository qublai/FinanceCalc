...
class Gtest(Shoptest):
    def __init__(self):
        print("Welcome to the G Section!")

g = Gtest()
g.enterItems()

class Utest(Shoptest):
    def __init__(self):
        print("Welcome to the U Section!")

u = Utest()
u.enterItems()

class Etest(Shoptest)
    def __init__(self):
        print("Welcome to the E Section!")

e = Etest
e.enterItems()

class  Ttest(Shoptest)
    def __init__(self):
        print("Welcome to the T Section!")
